...
function onDragOver() {
  if (filesStore.currentFolder && myRole.value === 'editor') isDragging.value = true
}
...
function onDrop(event: DragEvent) {
  isDragging.value = false
  if (!filesStore.currentFolder || myRole.value !== 'editor' || !event.dataTransfer?.files.length) return
